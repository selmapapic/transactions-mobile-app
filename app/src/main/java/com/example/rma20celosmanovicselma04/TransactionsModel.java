    ...
    public static ArrayList<Transaction> transactions = new ArrayList<Transaction>() {
        {
            ...
            add(new Transaction(LocalDate.of(2007, 8, 17), 580.0, "Penzija", TransactionType.REGULARINCOME, null, 30, LocalDate.of(2025, 9, 9)));
            ...
            add(new Transaction(LocalDate.of(2021, 10, 10), 550.0, "Freelancerska plata", TransactionType.REGULARINCOME, null, 15, LocalDate.of(2023, 10, 10)));
