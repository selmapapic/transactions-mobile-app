...
//            add(new Transaction(LocalDate.of(2021, 10, 10), 550.0, "Freelancerska plata", TransactionType.REGULARINCOME, "Plata za neki posao - Freelancing", 15, LocalDate.of(2023, 10, 10)));
