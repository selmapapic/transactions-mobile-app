...
public class TransactionContentProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        return database.delete(TransactionsDBOpenHelper.TRANSACTION_TABLE, selection, selectionArgs);
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        return database.update(TransactionsDBOpenHelper.TRANSACTION_TABLE, values, selection, selectionArgs);
    }
}
